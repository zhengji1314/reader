<template>
    <div class="book-detail" v-if="book">
        <div class="book">
			...
			<el-button style="float: right;height: 40px;" @click="back">返回</el-button>
        </div>
        <div class="btns">
            <el-button type="primary" @click="startRead">开始阅读</el-button>
            <el-button type="default" @click="insertShelf" :disabled="btnText !== '加入书架'">{{btnText}}</el-button>
        </div>
        ...
        methods: {
            ...
            insertShelf() {
                if (localStorage.getItem('userInfo')) {
					this.book.collect =  this.book.collect + 1
